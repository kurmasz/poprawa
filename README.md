...
### Grading Workbook
Begin by opening this sample populated grading workbook [demo_populated_workbook.xlsx](demo/demo_populated_workbook.xlsx)
...
Open this sample user info `.csv`: [demo_student_roster.csv](demo/demo_student_roster.csv)
